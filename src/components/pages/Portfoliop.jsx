...
export default function Portfoliop() {
    return (
        <>
        <section className="bg-center bg-cover h-96" style={{backgroundImage: 'url("/assets/Mbanner.jpg")'}}>
  ...
  <div className="h-96 w-full bg-center bg-no-repeat bg-cover bg-white">
    ...
    >
      <p class="w-1/2 text-gray-800 text-xl font-bold">
